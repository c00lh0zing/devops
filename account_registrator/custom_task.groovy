                sshagent(['TYZ_SSH']) {
                    sh """
                        ...
                        scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ./$PRJ_NAME/custom_files/fio_exceptions.txt ${SSH_USER}@${DEST_HOST}:/opt/provisioning/$PRJ_NAME/env/
